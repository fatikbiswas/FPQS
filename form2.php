  ...
  <div class="reg">
	<form method="post" action="sqlinsert2.php">
       ...
       <label class="q" for="email">Email ID</label><br>
        ...
        <label class="q"for="comm">Select Commodity</label><br>
        <select class="states" name="comm">
            <option value="default">Select Commodity</option>
        <option value="Maize">Maize</option>
        <option value="Rice">Rice</option>
        <option value="Mustard">Mustard</option>
        <option value="jute">Jute</option>
        </select><br><br>
        <label class="q" for="price">Set Price For 1 KG</label><br>
		<input class="states" type="text" name="price">
        <br><br>
        <label class="q" for="licence">Licence Number</label><br>
		<input class="states" type="text" name="licence">
        <br><br>
		<br>
